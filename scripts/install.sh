#!/usr/bin/env bash
# One-shot installer for KBAI
# Usage: curl -fsSL <url>/install.sh | DOMAIN=your-vps-ip bash
...
download "nginx/kbai-anythingllm.conf.template"
